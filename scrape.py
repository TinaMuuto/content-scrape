...
def scrape_single_url(url, do_inventory=True, fetch_sizes=False, check_links=False):
    """
    ...
    if check_links:
        ...
        for tag in soup.find_all(['a', 'link'], href=True):
            ...
            if href and not href.startswith(('mailto:', 'tel:')):
                ...
                all_links_on_page.add(full_url)
        # Find all image/script sources
