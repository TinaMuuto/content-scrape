...
<style>
    ...
    /* Style the file uploader and its button */
    ...
    /* Target the column containing the controls to align items to the bottom */
    div[data-testid="stVerticalBlock"] div.element-container:has(button[kind="primary"]){
        display: flex;
...
st.write("To begin, either paste URLs directly into the text box or upload an Excel file. The app will automatically extract valid URLs starting with 'https://' or 'http://'.")
